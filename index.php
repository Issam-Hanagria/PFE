...
if (isset($_POST['submitL'])) {
    ...
    $sql = "SELECT * FROM users WHERE email = '$email' && mdp = '$pass'";
    $resultat = mysqli_query($conn, $sql);
        ...
        <form class="modal-content" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
            <div class="modal-body">
                ...
                <div class="mb-3 mx-5 px-5">
                    <input type="email" class="form-control bg-light" id="floatingInput" name="email" placeholder="Votre E-mail" required>
                </div>
                <div class="mb-3 mx-5 px-5">
                    <input type="password" class="form-control bg-light" id="floatingPassword" name="password" placeholder="Mot de passe" required>
                    <p class="text-end fs-7">mot de passe oublié ?</p>
                </div>
                <div class="d-flex justify-content-center">
                    <button type="submit <?php echo $exist ? 'button' : 'submit'; ?>" name="submitL" class="btn btn-lg btn-primary rounded-pill">Se connecter</button>
                </div>
            </div>
        </form>
    </div>
...
<div class="modal fade" id="exampleModalToggle3" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1" >
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content" id="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
            <div class="modal-body">
                <h3 class="text-center Saira" id="staticBackdropLabel">Se Connecter</h3>
                <hr class="w-25 mx-auto mt-0 text-primary show-opacity h-3 rounded">
                <p class="text-center">Vous n'avez pas encore de compte ? <button class=" text-primary border-0 bg-body" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">Créer un compte</button></p>
                ...
                <div class="alert alert-danger w-65 mx-auto align text-center p-2" role="alert" id="logErr">
        ...
        <form class="modal-content" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
            <div class="modal-body">
                ...
                <div class="d-flex gap-2 mb-3 mx-5 px-5">
                    <input type="text" class="form-control bg-light w-50" id="floatingInput" name="nom" placeholder="Nom" required>
                    <input type="text" class="form-control bg-light w-50" id="floatingInput" name="prenom" placeholder="Prénom" required>
                </div>
                <div class="mb-3 mx-5 px-5">
                    <input type="email" class="form-control bg-light" id="email" name="email" placeholder="Votre E-mail" required>
                    <span class="text-danger d-none">E-mail existe déjà !</span>
                </div>
                <div class="mb-3 mx-5 px-5">
                    <input type="password" class="form-control bg-light" id="passwordR" name="password" placeholder="Mot de passe" required>
                    <span class="d-none text-danger" id="passMsg">Minimum 8 caractères !</span>
                </div>
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" name="submitR" class="btn btn-lg btn-primary rounded-pill">Créer un compte</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
            <div class="modal-body">
                ...
                <div class="mb-3 mx-5 px-5">
                    <input type="password" class="form-control bg-light" id="password" id="password" name="password" placeholder="Mot de passe" required>
                    <span class="text-danger d-none">Minimum caractère 8 !</span>
                </div>
                <div class="form-check ms-5 fs-6 mb-3">
                    <input class="form-check-input" type="checkbox" name="ConditionsBox" id="term&Privacy" checked required>
                    <label class="form-check-label" for="term&Privacy">
